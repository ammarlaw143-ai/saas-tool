    ...
    <div className="min-h-[85vh] flex items-center justify-center px-4 relative">
      ...
      <div className="w-full max-w-md bg-card/60 border border-border/40 backdrop-blur-md rounded-3xl p-8 shadow-2xl relative">
        ...
        <div className="space-y-2 text-center mb-8">
          ...
          <p className="text-xs text-muted-foreground">Sign in to your browser utilities workspace.</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between items-center">
              ...
              <Link href="/auth/forgot-password" className="text-[10px] text-indigo-400 font-bold hover:underline">
                Forgot password?
              </Link>
            </div>
            <div className="relative">
